...
function Covid () {
  return (
    <div className="news-covid p-4  ">
        <div className="header row m-0">
          <div className="title1 col-lg-6 p-0 d-flex align-items-center justify-content-between">
            <p className="text-17 bold-700 text-dark-gray border-b-red title-covid">PERKEMBANGAN COVID-19</p>
            <p>|</p>
          </div>
          <div className="title2 col-lg-6 d-flex p-0 pl-1 align-items-center">
            <p className="text-17 bold-700 text-red text-dark-gray">KASUS</p>
            <p className="text-17 bold-700 ml-3 text-dark-gray">PETA PERSEBARAN</p>
          </div>
